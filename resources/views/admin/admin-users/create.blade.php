...
@section('title', 'إضافة مستخدم جديد -مضلات وسواتر الرياض')
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">قم بملء التفاصيل لإضافة مستخدم إداري جديد</p>
        </div>
        <a href="{{ route('admin.admin-users.index') }}" class="mt-4 md:mt-0 inline-flex items-center text-[#1a5d7a] hover:underline">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <form action="{{ route('admin.admin-users.store') }}" method="POST" id="userForm">
            @csrf
            <div class="p-6">
...
<div id="loadingOverlay" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 hidden">
    <div class="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center justify-center w-80">
        ...
        <h2 class="text-gray-800 text-xl font-semibold mt-6">جاري حفظ المستخدم</h2>
        <p class="text-gray-600 mt-2 text-center">يتم الآن حفظ المستخدم وإعداده للنظام، الرجاء الانتظار...</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        userForm.addEventListener('submit', function(e) {
            ...
            if (!passwordField.value.trim()) {
                ...
                isValid = false;
                if (!errorMessage) errorMessage = 'كلمة المرور مطلوبة.';
